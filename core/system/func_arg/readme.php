...
>> Information
	...
	03-22-2017		Poen		08-10-2018	Poen		Improve the program.
...
>> Usage Function
	...
	function test($var=null)
	{
		if(csl_func_arg::double2error(0))
		{
			echo 'Error Type : '.strtolower(gettype($var));
		}
		else
	...
	function test($var=null)
	{
		if(csl_func_arg::numeric2error(0))
		{
			echo 'Error Type : '.strtolower(gettype($var));
		}
		else
	...
	function test($var=null)
	{
		if(csl_func_arg::object2error(0))
		{
			echo 'Error Type : '.strtolower(gettype($var));
		}
		else
	...
	function test($var=null)
	{
		if(csl_func_arg::resource2error(0))
		{
			echo 'Error Type : '.strtolower(gettype($var));
		}
		else
	...
	function test($var=null)
	{
		if(csl_func_arg::string2error(0))
		{
			echo 'Error Type : '.strtolower(gettype($var));
		}
		else
